...
class AutoOldmaid:
    ...
    def preparation(self,playerNum):
        ...
        stock = [("Spade_A",1),("Spade_2",2),("Spade_3",3),("Spade_4",4),("Spade_5",5),("Spade_6",6),("Spade_7",7),("Spade_8",8),("Spade_9",9),("Spade_10",10),("Spade_J",11),("Spade_Q",12),("Spade_K",13),
             ("Club_A",1),("Club_2",2),("Club_3",3),("Club_4",4),("Club_5",5),("Club_6",6),("Club_7",7),("Club_8",8),("Club_9",9),("Club_10",10),("Club_J",11),("Club_Q",12),("Club_K",13),
             ("Diamond_A",1),("Diamond_2",2),("Diamond_3",3),("Diamond_4",4),("Diamond_5",5),("Diamond_6",6),("Diamond_7",7),("Diamond_8",8),("Diamond_9",9),("Diamond_10",10),("Diamond_J",11),("Diamond_Q",12),("Diamond_K",13),
             ("Heart_A",1),("Heart_2",2),("Heart_3",3),("Heart_4",4),("Heart_5",5),("Heart_6",6),("Heart_7",7),("Heart_8",8),("Heart_9",9),("Heart_10",10),("Heart_J",11),("Heart_Q",12),("Heart_K",13),
             ("Joker",0)]
        ...
        while game_loop:
            ...
            for i in range(playerNum):
                ...
                if len(playerHand[i]) != 1 and len(playerHand[i + 1]) != 1:
                    ...
                    print("{} Pull {}".format(playerHand[i][0], player_choice_card))
                    ...
                    for j in range(len(playerHand[i])):
                        ...
                        if val != playerHand[i][j][0] and num == playerHand[i][j][1]:
